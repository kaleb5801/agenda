...
public class AddressBook {
    ...
    public void load() throws IOException{
        ...
        String fileName = String.format("src%scom%skaleb%scontactos.csv",separador,separador,separador);
    ...
    public void save() throws IOException{
        ...
        String fileName = String.format("src%scom%skaleb%scontactos.csv",separator,separator,separator);
        Path path = Paths.get(fileName);
